...
import Collapsible from "@/components/organisms/accordion/Collapsible";
import EmailAddressInput from "@/components/organisms/form/EmailAddressInput";
  ...
  return (
    <div>
      ...
      <div className="mx-auto px-6 min-[600px]:px-8 min-[960px]:px-20 xl:px-[148px] min-[1920px]:px-[354px] z-50 max-w-[120rem] w-full -mt-8 space-y-14 min-[800px]:space-y-16">
        ...
        <div className="space-y-4">
          <h5 className="text-2xl">Frequently Asked Questions</h5>
          <div className="space-y-2">
            <Collapsible items={faqQuestions} />
          </div>
        </div>
      </div>
    </div>
