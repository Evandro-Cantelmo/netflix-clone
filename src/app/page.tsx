...
export default function Home() {
  return (
    <div className="z-20">
      <div className="relative h-[98.56vh]">
        ...
        <div className="z-40 absolute h-full w-full pt-[100px]">
          <div className=" w-full -mt-8 flex flex-col justify-center items-center h-[calc(100%-100px)] py-0 p-8">
            <div className="flex flex-col justify-center items-center mx-[394px] space-y-8 text-white">
              <div className="space-y-4 text-center">
                <h1 className="text-[3.5rem] leading-tight font-black">
              ...
              <div className="space-y-4 w-full text-center">
                ...
                <div className="h-14 space-x-2 flex items-center">
                  ...
                  />
                  <button className="text-2xl font-bold flex items-center justify-center gap-3 px-6 py-3 bg-[#E50914] rounded-[0.25rem]">
                    Get Started
                    <Image
                      src="/rightArrow.svg"
                      width={24}
